...
## Covert transaction_month 
    ...
    mse_min = 9999                   #set worst mse value to start with
    lr_min = 0.01
    ...
    print("Best RMSE is ",math.sqrt(mse_min),"\nlearning rate:",lr_min,"\nmin samples split:",min_samples_split_min,"\nmin samples leaf:",min_samples_leaf_min,"\nMax depth:",max_depth_min)
